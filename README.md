...
Feeding is in the firmware (otherwise if your Home Assistant goes offline there will be no feeding)
But can also be achieved via Home Assistant if required (I chose to do it all via ESP8622 firmware) by commenting out line 345 [feeding();]
